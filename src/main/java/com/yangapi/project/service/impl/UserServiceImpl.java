...
import static com.yangapi.project.constant.UserConstant.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 3. 插入数据
            User user = new User();
            String accessKey = RandomUtil.randomString(5) + SALT + userAccount;
            String secretKey = RandomUtil.randomString(8) + SALT + userAccount;
            user.setAccessKey(DigestUtil.md5Hex(accessKey));
            user.setSecretKey(DigestUtil.md5Hex(secretKey));
